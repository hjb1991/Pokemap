...
public final class PokemapSharedPreferences implements PokemapAppPreferences {
    ...
    private static final String USE_OWN_API = "use_own_api";
    ...
    @Override
    public void setShowGyms(boolean bool) {
        sharedPreferences.edit().putBoolean(SHOW_GYMS, bool).apply();
    }

    @Override
    public void setShowPokestops(boolean bool) {
        sharedPreferences.edit().putBoolean(SHOW_POKESTOPS, bool).apply();
    }

    @Override
    public boolean getUseOwnApi() {
        return sharedPreferences.getBoolean(USE_OWN_API, false);
    }

    @Override
    public void setUseOwnApi(boolean bool) {
        sharedPreferences.edit().putBoolean(USE_OWN_API, bool).apply();
    }
