...
//                    con2.setRequestProperty("User-Agent","GoogleAuth/1.4 (Coolpad8297 KOT49H)");
//                    con2.setRequestProperty("Content-Type","text/plain; charset=UTF-8");
                    try {
                        ...
                        LunaLog.d("con2 code: " + con2.getResponseCode());
                    ...
                    Map<String, String> headers = request.getRequestProperties();
